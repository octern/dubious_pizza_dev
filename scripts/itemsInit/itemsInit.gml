...
itemsSetup(itemType.poemC, "Poem (1)", SPoemC, SPoemCHD, "I don't think my friend has a cat...", "", 1, 0);
itemsSetup(itemType.poemK, "Poem (2)", SPoemK, SPoemKHD, "This poem is deep ", "", 1, 1);
...
itemsSetup(itemType.key, "Key", SKey, SKey, "Use keys to open doors", "", 1, 10);
itemsSetup(itemType.box, "Pizza box", SPizzaBox, SPizzaBox, "Where did this pizza box come from?", "", 1, 11);
