...
/// @param invok bool accept even if overlapping with inventory
...
invok = argument_count >= 6 ? argument[5] : false;
...
invOverlap = !invok && position_meeting(cx, cy, OInvSlot);
...
active = !coverlap && ctext==0 && !invOverlap;
