...
draw_text_ext_transformed_color(subTitleX, subTitleY, subTitleText, subTitleLineHeight*.7 , -1, subTitleFactor, subTitleFactor, 0, c_fuchsia, c_fuchsia, c_fuchsia, c_fuchsia, 1);
...
for(i=0; i<instance_number(OTextAreaBG); i++) {
	with(instance_find(OTextAreaBG, i)) {
		...
		draw_text_ext_transformed_color(originMidX, y, words, 10, sprite_width, 1, 1, 0, c_white,  c_white,  c_white,  c_white, 1);
