...
dial1 = instance_create_depth(x+35, y+sprite_height/2 - 3, depth-1, ODial);
//dial5 = instance_create_layer(x-5, y-5, "Instances", ODial);
dial2 = instance_create_depth(x+sprite_width-32-35, y+sprite_height/2-3, depth-1, ODial);
dial3 = instance_create_depth(x+35, y+sprite_height-32-70, depth-1, ODial);
dial4 = instance_create_depth(x+sprite_width-32-35, y+sprite_height-32-70, depth-1, ODial);
