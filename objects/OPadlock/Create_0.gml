...
dial1 = instance_create_depth(x+18, y+sprite_height/2-13, -20, ODial);
//dial5 = instance_create_layer(x-5, y-5, "Instances", ODial);
dial2 = instance_create_depth(x+sprite_width-32-14, y+sprite_height/2-13, -20, ODial);
dial3 = instance_create_depth(x+18, y+sprite_height-32-34, -20, ODial);
dial4 = instance_create_depth(x+sprite_width-32-14, y+sprite_height-32-34, -20, ODial);
